	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'experience-card': 'hsl(var(--experience-card))',
				'experience-border': 'hsl(var(--experience-border))',
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { boxShadow: '0 0 10px hsl(var(--accent) / 0.3)' },
					'50%':      { boxShadow: '0 0 24px hsl(var(--accent) / 0.6)' }
				},
				'marquee': {
