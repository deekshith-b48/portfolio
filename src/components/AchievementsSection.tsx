...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    title: "Community Building for Open Source",
    organization: "Career Nexus Initiative",
    type: "contribution",
    date: "2024 - Present",
    status: "Contributor",
    description: "Initiated Career Nexus, helping peers discover and contribute to open-source opportunities.",
    detailedDescription: "Founded and led Career Nexus, a community initiative focused on helping fellow students and developers discover open-source opportunities, hackathons, and career development resources. The initiative has helped numerous individuals start their open-source journey.",
    technologies: ["Community Management", "Mentorship", "Workshop Facilitation", "Content Creation"],
    links: [],
    highlights: [
      "🌐 Built community of 100+ developers",
      "🎯 Organized 10+ workshops and events",
      "�� Connected developers with opportunities",
      "📈 Increased open-source participation by 40%",
      "🏆 Facilitated 50+ successful project contributions"
    ],
    impact: [
      "Empowered developers with opportunities",
      "Increased open-source community participation",
      "Facilitated career development for peers",
      "Promoted collaborative learning culture"
    ],
    icon: "🌐"
  }
];
...
export function AchievementsSection() {
  ...
  return (
    <section id="achievements" className="container max-w-screen-2xl px-6 py-24 relative">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/5 via-transparent to-green-500/5 blur-3xl" />
