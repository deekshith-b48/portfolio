  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "deekshithb.22CS038.nc@cambridge.edu.in",
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="border-border/50 bg-card/50 hover:border-accent/30 transition-all duration-300 hover:scale-105">
            <CardContent className="p-4 text-center">
              ...
              <Button variant="outline" size="sm" asChild className="w-full">
                <a href="mailto:deekshithb.22CS038.nc@cambridge.edu.in">
                  Send Email
                </a>
              </Button>
            </CardContent>
          ...
          <Card className="border-border/50 bg-card/50 hover:border-accent/30 transition-all duration-300 hover:scale-105">
            <CardContent className="p-4 text-center">
              ...
              <Button variant="outline" size="sm" asChild className="w-full">
                <a href="mailto:deekshithb.22CS038.nc@cambridge.edu.in?subject=Schedule%20a%20Call">
                  Schedule
                </a>
              </Button>
            </CardContent>
