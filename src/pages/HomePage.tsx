          ...
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="flex-1 space-y-6">
              <div className="flex items-start gap-6">
                <Avatar className="w-24 h-24 md:w-32 md:h-32 ring-2 ring-accent/20">
                  <AvatarImage 
                    src="/lovable-uploads/2ff8e71d-bc1f-475a-b7d6-ee036deb909e.png" 
                    alt="Deekshith B Gowda"
                    className="object-cover"
                  />
                  <AvatarFallback className="text-2xl font-bold bg-gradient-to-br from-accent to-primary text-background">
                    DG
                  </AvatarFallback>
                </Avatar>
                ...
                <div className="space-y-3 flex-1">
                  <div>
                    ...
                    <p className="text-xl text-accent font-medium">Full Stack Developer</p>
                    <p className="text-muted-foreground">CS Engineering Student</p>
                  </div>
                  ...
                  <Badge variant="outline" className="bg-accent/10 border-accent/20 text-accent w-fit">
